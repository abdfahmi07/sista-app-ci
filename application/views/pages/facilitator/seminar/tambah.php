<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('facilitator/list_seminar') ?>"> Data Seminar</a></li>
    ...
    <div class="row">
        <div class="col-lg">
            <div class="card mb-3">
                <div class="card-body">
                    <h6 class="mb-0"> <span style="color:red;">*</span> Pendaftaran seminar hanya berlaku untuk
                        mahasiswa
    ...
    <div class="row">
        <div class="col-lg">
            <div class="card mb-4">
                <div class="card-body">
                    <form method="POST" action="<?= base_url('facilitator/tambah_seminar') ?>">
                        <div class="form-wrapper">
                            <div class="left-side flex-grow-1 mr-5">
                                <div class="form-group">
                                    <label for="nim">NIM</label>
                                    <input type="text" class="form-control" id="nim" placeholder="Masukan NIM"
                                        name="nim" value="<?= $user['nim'] ?>" readonly>
                                    <?= form_error('nim', '<small class="text-danger">' , '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="name">Nama Mahasiswa</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="<?= $user['name'] ?>" placeholder="Masukan Nama Mahasiswa" readonly>
