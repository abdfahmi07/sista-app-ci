<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= base_url('seminar') ?>"> Data Seminar Peserta</a></li>
        ...
        <div class="col-lg">
            <div class="card mb-3">
                <div class="card-header pb-0">
                    <h6 class="mb-0 mt-1 font-weight-bold">Info Mahasiswa</h6>
                    <hr class="mt-2">
                </div>
                <div class="card-body pt-0 detail-peserta-seminar">
                    <div class="left-side">
                        <h6>Nama Mahasiswa/i </h6>
                        <h6>NIM</h6>
                    </div>
                    <div class="right-side">
                        <h6>: &nbsp;<?= $seminar_with_pembimbing->nama_mahasiswa ?></h6>
                        <h6>: &nbsp;<?= $seminar_with_pembimbing->nim ?></h6>
                    </div>
                </div>
            </div>
        </div>
