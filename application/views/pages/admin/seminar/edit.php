<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form method="POST" action="<?= base_url('seminar/update') ?>">
                            ...
                            <div class="left-side flex-grow-1 mr-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nim" placeholder="Masukan NIM"
                                        name="nim" value="<?= $seminar->nim ?>">
                                    <?= form_error('nim', '<small class="text-danger">' , '</small>') ?>
                                </div>
                                <div class="form-group">
                                    <label for="name">Nama Mahasiswa</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="<?= $seminar->nama_mahasiswa ?>" placeholder="Masukan Nama Mahasiswa">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="prodi" name="prodi">
                                        <option value="Teknik Informatika"
                                            <?= $seminar->prodi == 'Teknik Informatika' ? 'selected' : '' ?>>
                                            Teknik Informatika</option>
                                        <option value="Sistem Informasi"
                                            <?= $seminar->prodi == 'Sistem Informasi' ? 'selected' : '' ?>>Sistem
                                            Informasi</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="1" max="10" class="form-control col-lg-6" id="semester"
                                        name="semester" value="<?= $seminar->semester ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date-of-seminar" name="date_of_seminar"
                                        value="<?= $seminar->tanggal ?>" placeholder="Masukan Tanggal Seminar">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" id="time-of-seminar" name="time_of_seminar"
                                        value="<?= $seminar->jam ?>" placeholder="Masukan Waktu Seminar">
                            ...
                            <div class="right-side flex-grow-1">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ruangan" name="ruangan"
                                        value="<?= $seminar->ruangan ?>" placeholder="Masukan Ruangan">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="title" rows="3" name="title"
                                        placeholder="Masukan Judul TA"><?= $seminar->judul ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="seminar" name="seminar">
                                        ...
                                        <option value="<?= $row->id ?>"
                                            <?= $row->id == $seminar->kategori_seminar_id ? 'selected' :''?>>
                                            <?= $row->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="pembimbing" name="pembimbing">
                                        ...
                                        <option value="<?= $row->id ?>"
                                            <?= $row->id == $seminar->pembimbing_id ? 'selected' :'' ?>>
                                            <?= $row->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="penguji1" name="penguji1">
                                        ...
                                        <option value="<?= $row->nidn ?>"
                                            <?= $row->nidn == $seminar->penguji1_id ? 'selected' :''?>>
                                            <?= $row->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="penguji2" name="penguji2">
                                        <?php foreach($dosen->result() as $row) : ?>
                                        <option value="<?= $row->nidn ?>"
                                            <?= $row->nidn == $seminar->penguji2_id ? 'selected' :''?>>
                                            <?= $row->nama ?></option>
                                        <?php endforeach; ?>
                                    </select>
